...
def create_cnn_model(
    ...
    conv3 = nn.Conv1d(n_filters1, n_filters2, kernel_size=kernel_size, padding=kernel_size // 2)
   ...
   # print(f"Model Init: SeqLen {seq_len} -> Reduced to {len_after_pool2} steps -> Linear Input {linear_input_size}")
    ...
    return {'conv1': conv1, 'bn1': bn1, 'conv2': conv2, 'bn2': bn2, 'conv3': conv3, 'bn3': bn3, 'pool':pool, 'linear': linear}   
