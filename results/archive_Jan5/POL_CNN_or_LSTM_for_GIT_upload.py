...
#010526   X_train, X_val, y_train, y_val = train_test_split(X_train_all, y_train_all, test_size=0.15, shuffle=True, random_state=97)

# We use a co##iguous split to ensure the validation set is truly "unseen" time-wise.
