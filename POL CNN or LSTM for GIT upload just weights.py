...
def train_model(model_type, data, pos_weight, epochs=60, batch_size=128):
   ...
   # --- MODEL SWITCHING LOGIC RESTORED ---
    ...
    return models, forward_fn, history, initial_weights, final_weights
...
if __name__ == "__main__":
    ...
    # 3. Train
    models, fwd_fn, history, initial_weights, final_weights = train_model('cnn', data, pos_weight, epochs=30, batch_size=128)

    
    ## Now you can access any weight tensor like this:
    #Example: Get he weight tensor for 1sst conv layer
    # initial_conv1_weights = initial_weights['conv1']['weight']
    # final_conv1_weights = final_weights['conv1']['weight']

    # print("Shape of initial conv1 weights:", initial_conv1_weights.shape)
    # print("Shape of final conv1 weights:", final_conv1_weights.shape)
